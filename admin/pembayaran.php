                ...
                <td>
                    <?php 
                        if($kekurangan==0){
                            ...
                            ?> 
                            <a href="?url=tambah-pembayaran&nisn=<?= $data['nisn'] ?>&kekurangan=<?= $kekurangan ?> class=btn btn-danger"> Pilih & Bayar
                            <?php } ?> </a>
                    
                </td>
                <td>
                    <a href="?url=histori-pembayaran&nisn=<?= $data['nisn']  ?>" class="btn btn-danger">history</a>
                </td>
            </tr>
        <?php 
        } ?>
