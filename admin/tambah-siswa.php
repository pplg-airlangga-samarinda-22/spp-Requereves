...
<form method="post" action="?url=proses-tambah-siswa">
    ...
    <div class="form-group mb-2">
        ...
        <select name="id_kelas" class="form-control" required>
            ...
            <?php include '../koneksi.php'; $kelas = mysqli_query($koneksi,"SELECT * FROM kelas ORDER BY nama_kelas ASC");
    ...
    <div class="form-group mb-2">
        ...
        <select name="id_spp" class="form-control" required>
            ...
            <?php include '../koneksi.php'; $spp = mysqli_query($koneksi,"SELECT * FROM spp ORDER BY id_spp ASC");
